...
export function CompareTab({ myStats, myScore, myPercentile }: CompareTabProps) {
    ...
    const { isLoading, error, stats: theirStats, score: theirScore, percentile: theirPercentile, fetch, clear } = useCompareWallet();

    const handleSearch = () => {
        if (searchAddress.trim()) {
            fetch(searchAddress.trim());
        }
    };
        ...
        <div className="space-y-6">
            ...
            <div className="flex gap-2">
                <input
                    ...
                    placeholder="Enter address (0x...) or basename"
